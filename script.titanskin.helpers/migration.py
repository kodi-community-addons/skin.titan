...
def fullMigration():
    ...
    if not WINDOW.getProperty("titanmigration"):
        xbmc.log("TITAN SKIN --> Starting migration of Titan skin")
        ...
        xbmc.log("TITAN SKIN --> Finished migration of Titan skin")
    else:
        xbmc.log("TITAN SKIN --> Migration already running... skipped")
...
def migrateSkinShortcuts():
    ...
    try:    
        ...
        xbmc.log("TITAN SKIN --> Error in migrateSkinShortcuts.....")
        print_exc()
        xbmc.rmdir("special://home/userdata/addon_data/script.skinshortcuts/")
